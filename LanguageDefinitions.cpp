...
namespace ImGuiColorTextEdit {
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::CPlusPlus()
	{
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::HLSL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::GLSL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::Python()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::C()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::SQL()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::AngelScript()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::Lua()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::CSharp()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::Json()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
	...
	const ImGuiColorTextEdit::TextEditor::LanguageDefinition& ImGuiColorTextEdit::TextEditor::LanguageDefinition::Yaml()
	{
		static bool inited = false;
		static LanguageDefinition langDef;
		if (!inited)
		{
			...
			langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("[+-]?([0-9]+([.][0-9]*)?|[.][0-9]+)([eE][+-]?[0-9]+)?", PaletteIndex::Number));
			langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("[\\[\\]\\{\\}\\!\\%\\^\\&\\*\\(\\)\\-\\+\\=\\~\\|\\<\\>\\?\\/\\;\\,\\.\\:]", PaletteIndex::Punctuation));
			langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>(".*:", PaletteIndex::KnownIdentifier));
			langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("false|true", PaletteIndex::Keyword));
